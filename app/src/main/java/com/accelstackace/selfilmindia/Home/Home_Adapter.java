...
import static com.accelstackace.selfilmindia.R.drawable.ic_baseline_music_note_24;
import static com.accelstackace.selfilmindia.R.drawable.ic_baseline_music_off_24;
import static com.accelstackace.selfilmindia.R.drawable.ic_baseline_visibility_off_24;
...
public class Home_Adapter extends RecyclerView.Adapter<Home_Adapter.CustomViewHolder > {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout like_layout,comment_layout,shared_layout,sound_image_layout,report_layout,mutelay;
        ImageView like_image,comment_image,muteimg;
        ...
        public CustomViewHolder(View view) {
            ...
            report_layout=view.findViewById(R.id.reportlay);
            ...
            muteimg=view.findViewById(R.id.muteimg);
        ...
        public void bind(final int postion,final Home_Get_Set item, final Home_Adapter.OnItemClickListener listener) {
            ...
            mutelay.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    if (is_mute == false){
                        muteimg.setImageResource(ic_baseline_music_off_24);
                        is_mute = true;
                    }
                    else if (is_mute==true){
                        muteimg.setImageResource(ic_baseline_music_note_24);
                        is_mute = false;
                    }
