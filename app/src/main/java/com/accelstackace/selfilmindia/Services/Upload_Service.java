package com.accelstackace.selfilmindia.Services;
...
import com.accelstackace.selfilmindia.SimpleClasses.MultiPartRequest;
                    ...
                    MultiPartRequest request=new MultiPartRequest(Upload_Service.this, new Callback() {
                        ...
                        public void Responce(String resp) {
                            ...
                            try {
                                ...
                                Toast.makeText(Upload_Service.this, resp.toString(), Toast.LENGTH_SHORT).show();
                                e.printStackTrace();
                            }
