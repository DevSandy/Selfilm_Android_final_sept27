package com.accelstackace.selfilmindia.Profile;
...
import com.accelstackace.selfilmindia.Profile.Private_Videos.PrivateVideo_F;
import com.accelstackace.selfilmindia.Settings.Setting_F;
...
import com.accelstackace.selfilmindia.Following.Following_F;
...
import com.accelstackace.selfilmindia.Profile.Liked_Videos.Liked_Video_F;
import com.accelstackace.selfilmindia.Profile.UserVideos.UserVideo_F;
import com.accelstackace.selfilmindia.R;
import com.accelstackace.selfilmindia.See_Full_Image_F;
...
import com.accelstackace.selfilmindia.Video_Recording.DraftVideos.DraftVideos_A;
...
public class Profile_Tab_F extends RootFragment implements View.OnClickListener  {
    ...
    public  TextView follow_count_txt,fans_count_txt,heart_count_txt,draft_count_txt,biotxt;
    public Button editproilebtn;
    ...
    public View init(){
        ...
        editproilebtn=view.findViewById(R.id.editprofilebtn);
...
//        pic_url = Variables.sharedPreferences.getString(Variables.u_pic, "null");
    ...
    private void setupTabIcons() {
        ...
        imageView1.setImageDrawable(getResources().getDrawable(R.drawable.ic_my_video_gray));
        tabLayout.getTabAt(0).setCustomView(view1);

        View view2 = LayoutInflater.from(context).inflate(R.layout.item_tabs_profile_menu, null);
        ImageView imageView2= view2.findViewById(R.id.image);
        imageView2.setImageDrawable(getResources().getDrawable(R.drawable.ic_liked_video_color));
    ...
    public void Parse_data(String responce){
        ...
        try {
            ...
            if(code.equals("200")){
                ...
                biotxt.setText(data.optString("bio"));
