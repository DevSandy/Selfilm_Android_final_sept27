...
public class Discover_Adapter extends RecyclerView.Adapter<Discover_Adapter.CustomViewHolder > implements Filterable {
    ...
    public interface OnItemClickListener {
        void onItemClick(ArrayList<Home_Get_Sett> video_list, int postion);
    }
    ...
    public Discover_Adapter.CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewtype) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_discover_layout_movies, viewGroup, false);
    ...
    class Horizontal_Adapter extends RecyclerView.Adapter<Horizontal_Adapter.CustomViewHolder> {
        ...
        ArrayList<Home_Get_Sett> datalist;


        public Horizontal_Adapter(Context context, ArrayList<Home_Get_Sett> arrayList) {
            this.context = context;
            datalist = arrayList;
        }
        ...
        class CustomViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final int pos, final ArrayList<Home_Get_Sett> datalist) {
        ...
        public void onBindViewHolder(final Horizontal_Adapter.CustomViewHolder holder, final int i) {
            holder.setIsRecyclable(false);
                ...
                Home_Get_Sett item = datalist.get(i);
                ...
                try {
                    ...
                    if(Variables.is_show_gif) {
                        ...
                        if(item.Movie_Thum!=null && !item.Movie_Thum.equals("")) {
                            Uri uri = Uri.parse(item.Movie_Thum);
